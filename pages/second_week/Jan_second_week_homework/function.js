...
console.log(movieTiketPrice("일반", 1, true));
console.log(movieTiketPrice("일반", 1, false));
console.log(movieTiketPrice("3D", 1, true));
console.log(movieTiketPrice("3D", 1, false));
console.log(movieTiketPrice("IMAX", 1, true));
console.log(movieTiketPrice("IMAX", 1, false));
